...
export const ContactIntro = () => {
  return (
    <div className="text-center">
      ...
      <button className="w-[160px] h-[50px] rounded-[22px] text-xl text-center border-[1.5px] border-white bg-gradient-to-r from-[#BB6FFB]/30 via-[#FC5F67]/30 to-[#FFB054]/30 text-white font-medium  items-center">
        Quick Chat
      </button>
    </div>
  );
