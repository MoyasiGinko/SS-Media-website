  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex justify-center z-50 px-4 py-3">
      <motion.nav
        className={`${
          isScrolled
            ? "bg-gradient-to-r from-gray-900/80 to-gray-800/80 max-w-2xl shadow-lg border border-white/10"
            : "bg-gradient-to-r from-gray-900/60 to-gray-800/60 max-w-6xl border border-white/5"
